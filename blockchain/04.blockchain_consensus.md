...
최근 대표되는 PoA 알고리즘에는 *IBFT 2.0*, *Clique*, *Aura* 등이 있다. 

IBFT 2.0 합의 프로토콜의 특징은 다음과 같습니다.
...
https://www.ccn.com/education/a-comparative-analysis-of-proof-of-authority-consensus-algorithms-aura-vs-clique/
...
Clique can run with a single validator.  As the number of validators in a Clique network increases, the probability of forks in the network increases.
...
https://consensys.io/blog/hyperledger-besu-understanding-proof-of-authority-via-clique-and-ibft-2-0-private-networks-part-1
