...
비트코인 룬은 다음과 같은 장점을 가진다.

- **효율적인 표준**: 룬은 대체 가능한 토큰의 발행을 용이하게 하며 사용자가 토큰을 더욱 손쉽게 생성할 수 있도록 설계되었다.
- **효율적인 표준** : 
- **UTXO 기반:** 룬은 UTXO 공간을 활용하므로 비트코인의 기존 시스템과 원활하게 작동합니다.
- **라이트닝 호환:** 기존 토큰 표준과는 달리, 룬은 라이트닝 네트워크에서의 송수신이 가능하여, 거래를 더 빠르고 저렴하게 할 수 있다.
